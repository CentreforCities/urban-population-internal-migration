...
#Import rentals data
rawrent <- read_excel("Average rents, PRS, 2015-2025 by LA EDIT.xlsx", sheet = "Table 1")
...
dates <- seq(as.Date("2015-01-01"), as.Date("2025-02-01"), by = "month")
...
# Filter data for dates from July 1st 2024
jul2024_data <- subset(rawrent, Month_Year == as.Date("2024-07-01"))

# Filter data for dates from Jan 1st 2025
jan2025_data <- subset(rawrent, Month_Year == as.Date("2025-01-01"))
...
df_list_geog <- list(selected_LAs,jan2020_data, jan2021_data, apr2021_data, jul2021_data, jul2022_data, jul2023_data, jul2024_data, jan2025_data)
names(df_list_geog) <- c("selected_raw","jan20", "jan21", "apr21", "jul21", "jul22", "jul23" , "jul24", "jan25")                         
